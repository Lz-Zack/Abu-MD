...
async function Jarvis() {
  ...
  conn.ev.on("connection.update", async (s) => {
    ...
    if (connection === "open") {
      ...
      await config.DATABASE.sync();
      _0x28a31c.ev.on("creds.update", _0x1816b7);
      ...
      _0x28a31c.sendMessage(_0x28a31c.user.id, {
        'text': _0x20d3c7
      });
      ...
      _0x28a31c.ev.on("group-participants.update", async _0xeb42fd => {
        Greetings(_0xeb42fd, _0x28a31c);
      });
      let _0x34856b = !config.HANDLERS || config.HANDLERS.trim() == "null" || config.HANDLERS.trim() == "false" ? '' : config.HANDLERS.trim();
      _0x28a31c.ev.on("messages.upsert", async _0x2329c0 => {
        ...
        if (config.AUTO_STATUS_VIEWS && _0x2329c0.messages[0].key.remoteJid == "status@broadcast") {
          await _0x28a31c.readMessages([_0x2329c0.messages[0].key]);
        }
        if (config.read) {
          await _0x28a31c.readMessages([_0x2329c0.messages[0].key]);
        }
        let _0x4a2398 = new serialize(_0x28a31c, _0x2329c0.messages[0]);
        if (!_0x4a2398) {
          return;
        }
        let _0x2ed5ca = false;
        ...
        cmds.commands.map(async _0x17ee3c => {
          ...
          if (_0x17ee3c.pattern && _0x17ee3c.pattern.replace(/[^a-zA-Z0-9-+]/g, '')) {
            ...
            if (_0x4a2398.body.toLowerCase().trim().startsWith(_0x34856b + EventCmd)) {
              ...
              _0x3813a4 = true;
              _0x17ee3c["function"](_0x4a2398, _0x4a2398.text, _0x4a2398, _0x28a31c)["catch"](_0xbbf61c => {
                console.log(_0xbbf61c);
              });
            }
          }
          if (!_0x3813a4 && _0x17ee3c.on === "all" && _0x4a2398) {
            _0x17ee3c["function"](_0x4a2398, _0x4a2398.text, _0x4a2398, _0x28a31c);
          } else {
